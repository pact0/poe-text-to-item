export const Patterns = {
    ...
    AffixInfluenceExarch: /(Searing Exarch)/m,
    AffixInfluenceEater: /(Eater of Worlds)/m,
    ...
    InfluenceEater: /^Eater of Worlds Item$/m,
    InfluenceExarch: /^Searing Exarch Item$/m,
